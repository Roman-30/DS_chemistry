...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.label_7, 10, 10, 1, 1)

        self.label_13 = QLabel(self.centralwidget)
        self.label_13.setObjectName(u"label_13")

        self.gridLayout.addWidget(self.label_13, 12, 10, 1, 1)

        self.label_27 = QLabel(self.centralwidget)
        self.label_27.setObjectName(u"label_27")

        self.gridLayout.addWidget(self.label_27, 16, 10, 1, 1)

        self.label_14 = QLabel(self.centralwidget)
        self.label_14.setObjectName(u"label_14")
        self.label_14.setMaximumSize(QSize(50, 16777215))

        self.gridLayout.addWidget(self.label_14, 13, 9, 1, 1)

        self.label_8 = QLabel(self.centralwidget)
        self.label_8.setObjectName(u"label_8")

        self.gridLayout.addWidget(self.label_8, 10, 11, 1, 1)

        self.label_17 = QLabel(self.centralwidget)
        self.label_17.setObjectName(u"label_17")

        self.gridLayout.addWidget(self.label_17, 13, 11, 1, 1)

        self.label_21 = QLabel(self.centralwidget)
        self.label_21.setObjectName(u"label_21")

        self.gridLayout.addWidget(self.label_21, 14, 11, 1, 1)
        ...
        self.gridLayout.addWidget(self.open_button, 0, 3, 1, 3)
        ...
        self.gridLayout.addWidget(self.cut_button, 1, 3, 1, 3)

        self.label_12 = QLabel(self.centralwidget)
        self.label_12.setObjectName(u"label_12")
        self.label_12.setMaximumSize(QSize(50, 16777215))

        self.gridLayout.addWidget(self.label_12, 12, 9, 1, 1)

        self.label_19 = QLabel(self.centralwidget)
        self.label_19.setObjectName(u"label_19")
        self.label_19.setMaximumSize(QSize(50, 16777215))

        self.gridLayout.addWidget(self.label_19, 14, 9, 1, 1)

        self.label_2 = QLabel(self.centralwidget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setLayoutDirection(Qt.LeftToRight)

        self.gridLayout.addWidget(self.label_2, 3, 8, 1, 5)

        self.label_30 = QLabel(self.centralwidget)
        self.label_30.setObjectName(u"label_30")
        self.label_30.setLayoutDirection(Qt.LeftToRight)

        self.gridLayout.addWidget(self.label_30, 6, 8, 1, 3)
        ...
        self.widget.setMinimumSize(QSize(225, 300))
        ...
        self.gridLayout.addWidget(self.label_3, 2, 8, 1, 5)

        self.label_6 = QLabel(self.centralwidget)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setMaximumSize(QSize(50, 13))

        self.gridLayout.addWidget(self.label_6, 10, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.line, 8, 0, 1, 14)

        self.label_26 = QLabel(self.centralwidget)
        self.label_26.setObjectName(u"label_26")

        self.gridLayout.addWidget(self.label_26, 16, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.spline_display_radio_button, 5, 3, 1, 1)

        self.verticalSpacer = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.gridLayout.addItem(self.verticalSpacer, 17, 10, 1, 1)

        self.label_28 = QLabel(self.centralwidget)
        self.label_28.setObjectName(u"label_28")

        self.gridLayout.addWidget(self.label_28, 16, 11, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_2, 2, 3, 1, 5)
        ...
        self.gridLayout.addWidget(self.cancel_button, 1, 6, 1, 3)
        ...
        self.gridLayout.addWidget(self.label_22, 15, 9, 1, 1)

        self.label_10 = QLabel(self.centralwidget)
        self.label_10.setObjectName(u"label_10")

        self.gridLayout.addWidget(self.label_10, 11, 10, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit, 3, 3, 1, 5)
        ...
        self.gridLayout.addWidget(self.label_32, 0, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_33, 0, 10, 1, 1)
        ...
        self.gridLayout.addWidget(self.spline_button, 4, 3, 1, 4)

        self.label_23 = QLabel(self.centralwidget)
        self.label_23.setObjectName(u"label_23")

        self.gridLayout.addWidget(self.label_23, 15, 10, 1, 1)
        ...
        self.gridLayout.addWidget(self.calculate_button, 7, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_3, 6, 3, 1, 5)

        self.label = QLabel(self.centralwidget)
        self.label.setObjectName(u"label")
        self.label.setLayoutDirection(Qt.LeftToRight)

        self.gridLayout.addWidget(self.label, 5, 4, 1, 3)

        self.label_9 = QLabel(self.centralwidget)
        self.label_9.setObjectName(u"label_9")
        self.label_9.setMaximumSize(QSize(50, 16777215))

        self.gridLayout.addWidget(self.label_9, 11, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_29, 0, 6, 1, 2)
        ...
        self.gridLayout.addWidget(self.label_24, 15, 11, 1, 1)

        self.label_16 = QLabel(self.centralwidget)
        self.label_16.setObjectName(u"label_16")

        self.gridLayout.addWidget(self.label_16, 13, 10, 1, 1)

        self.label_20 = QLabel(self.centralwidget)
        self.label_20.setObjectName(u"label_20")

        self.gridLayout.addWidget(self.label_20, 14, 10, 1, 1)

        self.label_15 = QLabel(self.centralwidget)
        self.label_15.setObjectName(u"label_15")

        self.gridLayout.addWidget(self.label_15, 12, 11, 1, 1)
        ...
        self.gridLayout.addWidget(self.change_button, 1, 9, 1, 1)
        ...
        self.label_4.setMaximumSize(QSize(30, 20))

        self.gridLayout.addWidget(self.label_4, 7, 10, 1, 1)

        self.fault = QLineEdit(self.centralwidget)
        self.fault.setObjectName(u"fault")
        self.fault.setMinimumSize(QSize(45, 20))
        self.fault.setMaximumSize(QSize(100, 16777215))
